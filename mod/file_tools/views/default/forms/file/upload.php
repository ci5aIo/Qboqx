...
$file_input = elgg_view('input/file', array('name' => 'upload'));
/*$file_input = elgg_view('input/dropzone', array(
		'name' => 'upload_guids',
		'accept' => "*",
		'max' => 25,
		'multiple' => true,
...
$file_title = elgg_view('input/text', array('name' => 'title', 'value' => $title));
$file_description = elgg_view('input/longtext', array('name' => 'description', 'value' => $desc));
$file_tags = elgg_view('input/tags', array('name' => 'tags', 'value' => $tags));
...
if (file_tools_use_folder_structure()) {
	...
	if ($file = elgg_extract("entity", $vars)) {
		if ($folders = $file->getEntitiesFromRelationship(FILE_TOOLS_RELATIONSHIP, true, 1)) {
			...
			$file_folders = elgg_view("input/folder_select", array("name" => "folder_guid", "value" => $parent_guid));
		}
	}
	?>
	<div>
