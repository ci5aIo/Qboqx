...
//@EDIT 2018-03-15 - SAJ - Accepts text values not aligned with a group.
$text_value = elgg_extract('value', $vars);
...
?>
<div class="elgg-group-picker ui-front" data-limit="<?php echo $limit ?>" data-name="<?php echo $name ?>" data-value="<?php echo $text_value ?>" data-handler="<?php echo $handler ?>">
	<input value="<?php echo $text_value?>" name="<?php echo $name ?>" type="text" class="elgg-input-group-picker" size="30"/>
