...
if ($items){
    foreach ($items as $menu_item) {
        $children = NULL;
        echo elgg_view('navigation/flyout/categories/item', array(
    		'item' => $menu_item,
            'selected'=>$selected,
        ...
        $hierarchy = hypeJunction\Categories\get_hierarchy($selected, true, true);
        if (in_array($menu_item['guid'],$hierarchy)){
