...
elgg.widget_manager.init_admin = function() {
	$(".widget-manager-fix").on("click", function(event) {
	...
	$("#widget-manager-settings-add-extra-context").on("click", function(event) {
	...
	$("#widget-manager-settings-extra-contexts .elgg-icon-delete").on("click", function(event) {
